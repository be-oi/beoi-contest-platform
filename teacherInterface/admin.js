   ...
   models = {
      ...
      school: {
         ...
         fields: {
            ...
            nbStudents: {label: t("school_nbStudents_label"), longLabel: t("school_nbStudents_long_label"), editable: true, edittype: "text", subtype:"positiveint", width: 100, comment:t("school_nbStudents_comment"), required: true}
         }
      },
      school_search: {
      ...
      user_create: {
         tableName: "user",
         fields: {
            gender: {label: t("user_gender_label"), editable: true, edittype: "select", width: 20, editoptions:{ value:{"F": "Mme./Mvr.", "M": "M."}}, required:true},
...
function loadListQuestions() {
   loadGrid("question", "key", 20, [20, 50, 200], function(id) {
      ...
      var url = "beoi-contest-tasks/" + questions[id].path;
...
function genQuestion() {
   ...
   button.attr("disabled", true);
   tasks = []; // Reinit
   var url = "beoi-contest-tasks/" + questions[questionID].path;
   $("#preview_question").attr("src", url);
   // Retrieve bebras
   generating = true;
   $('#preview_question').load(function() {
